...
function preload(){
  myFont = loadFont ('assets/Kablammo-Regular-VariableFont_MORF.ttf');
  img1 = loadImage ('images/cherries.png');
  img2 = loadImage ('images/lollipop.png');
  img3 = loadImage ('images/mac_n_cheese.png');
}
...
function draw() {
  ...
  image (img1,390,290,250,400);
  
  fill(mouseX,125,mouseY);
  rect(705,705,20,700);
  
  fill(mouseX,125,mouseY);
  text("Hailey Mele", 820, 990);
  textSize(30);
